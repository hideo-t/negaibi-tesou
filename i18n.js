...
(function(){
  const I18N = {
    ja: {
      ...
      "nav.teller":"🔮 占い師募集","nav.emblem":"紋章","nav.more":"その他",
      "emblem.title":"世界に一つの、あなたの紋章",
      "emblem.intro":"AI が手相を読み解き、あなただけの「王名」と「紋章」を生成。<br>過去にお越しになった方々の紋章を、ほんの一部ご紹介します。",
      "emblem.tag.envoy":"神々の使者",
      "emblem.tag.ancient":"古代の流派",
      "emblem.tag.merchant":"商人型",
      "emblem.tag.healing":"癒しの泉",
      "emblem.tag.oracle":"霊的直感型",
      "emblem.tagline":"✦ あなたの手相が、あなただけの紋章を生む。 ✦",
      "emblem.video.title":"紋章は、あなたの宇宙",
      "emblem.video.sub":"— Your hand. Your cosmos. Your emblem. —",
      "museum.label":"MUSEUM OF EMBLEMS",
      "museum.main":"まるで、美術館におけるような、<br>あなただけの価値ある紋章",
    ...
    en: {
      ...
      "nav.teller":"🔮 Fortune Teller Recruit","nav.emblem":"Emblems","nav.more":"More",
      "emblem.title":"Your One-and-Only Emblem",
      "emblem.intro":"AI reads your palm and generates your own \"King Name\" and \"Emblem.\"<br>Here are a few emblems from past visitors.",
      "emblem.tag.envoy":"Divine Envoy",
      "emblem.tag.ancient":"Ancient School",
      "emblem.tag.merchant":"Merchant Type",
      "emblem.tag.healing":"Healing Spring",
      "emblem.tag.oracle":"Spiritual Oracle",
      "emblem.tagline":"✦ Your palm gives rise to your one-of-a-kind emblem. ✦",
      "emblem.video.title":"Your Emblem, Your Cosmos",
      "emblem.video.sub":"— Your hand. Your cosmos. Your emblem. —",
      "museum.label":"MUSEUM OF EMBLEMS",
      "museum.main":"Like a museum-worthy artwork —<br>your one and only emblem",
      "museum.sub":"— A masterpiece, born from your hand. —",
      "museum.piece.no":"No.342","museum.piece.label":"— Exhibit Piece —",
    ...
    "zh-TW": {
      ...
      "nav.teller":"🔮 占卜師招募","nav.emblem":"紋章","nav.more":"其他",
      "emblem.title":"獨一無二，您的紋章",
      "emblem.intro":"AI 解讀您的手相，為您生成專屬的「王名」與「紋章」。<br>以下是過去鑑定的紋章作品集錦。",
      "emblem.tag.envoy":"神之使者",
      "emblem.tag.ancient":"古代流派",
      "emblem.tag.merchant":"商人型",
      "emblem.tag.healing":"療癒之泉",
      "emblem.tag.oracle":"靈感直覺型",
      "emblem.tagline":"✦ 您的手相，誕生獨一無二的紋章。 ✦",
      "emblem.video.title":"紋章，是您的宇宙",
      "emblem.video.sub":"— Your hand. Your cosmos. Your emblem. —",
      "museum.label":"MUSEUM OF EMBLEMS",
      "museum.main":"如同美術館中的藝術品 —<br>唯一屬於您的紋章",
      "museum.sub":"— A masterpiece, born from your hand. —",
    ...
    "zh-CN": {
      ...
      "nav.teller":"🔮 占卜师招募","nav.emblem":"纹章","nav.more":"其他",
      "emblem.title":"独一无二，您的纹章",
      "emblem.intro":"AI 解读您的手相，为您生成专属的「王名」与「纹章」。<br>以下是过去鉴定的纹章作品集锦。",
      "emblem.tag.envoy":"神之使者",
      "emblem.tag.ancient":"古代流派",
      "emblem.tag.merchant":"商人型",
      "emblem.tag.healing":"疗愈之泉",
      "emblem.tag.oracle":"灵感直觉型",
      "emblem.tagline":"✦ 您的手相，诞生独一无二的纹章。 ✦",
      "emblem.video.title":"纹章，是您的宇宙",
      "emblem.video.sub":"— Your hand. Your cosmos. Your emblem. —",
      "museum.label":"MUSEUM OF EMBLEMS",
      "museum.main":"如同美术馆中的艺术品 —<br>唯一属于您的纹章",
      "museum.sub":"— A masterpiece, born from your hand. —",
      "museum.piece.no":"No.342","museum.piece.label":"— 展示作品 —",
    ...
    ko: {
      ...
      "nav.teller":"🔮 점술가 모집","nav.emblem":"문장","nav.more":"기타",
      "emblem.title":"세상에 단 하나뿐인 당신의 문장",
      "emblem.intro":"AI가 손금을 읽고, 당신만의 「왕명」과 「문장」을 생성합니다.<br>지금까지의 손님들에게 부여된 문장의 일부를 소개합니다.",
      "emblem.tag.envoy":"신의 사자",
      "emblem.tag.ancient":"고대의 유파",
      "emblem.tag.merchant":"상인형",
      "emblem.tag.healing":"치유의 샘",
      "emblem.tag.oracle":"영적 직감형",
      "emblem.tagline":"✦ 당신의 손금이, 단 하나뿐인 문장을 낳습니다. ✦",
      "emblem.video.title":"문장은, 당신의 우주",
      "emblem.video.sub":"— Your hand. Your cosmos. Your emblem. —",
      "museum.label":"MUSEUM OF EMBLEMS",
      "museum.main":"마치 미술관의 작품처럼 —<br>당신만의 가치 있는 문장",
      "museum.sub":"— A masterpiece, born from your hand. —",
